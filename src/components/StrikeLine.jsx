const StrikeLine = ({ strike }) => {
  ...
  const styles = {
    "row-1": "top-[19%] left-0 w-full h-1 animate-x",
    "row-2": "top-[50%] left-0 w-full h-1 animate-x",
    "row-3": "top-[80%] left-0 w-full h-1 animate-x",

    "col-1": "left-[19%] top-0 h-full w-1 animate-y",
    "col-2": "left-[50%] top-0 h-full w-1 animate-y",
    "col-3": "left-[80%] top-0 h-full w-1 animate-y",
